...
class Empty extends Ecom\Dev\PHPUnit\Test\Case {
    /**
     * @var \Klevu\Search\Model\Api\Response\Empty
     */
    protected $_apiResponseEmpty;

    public function __construct(\Klevu\Search\Model\Api\Response\Empty $apiResponseEmpty)
    {
